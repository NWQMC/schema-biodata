...
--changeset drsteini:WQP_740_biodata_site_flagged_delete
alter table biodata_site add (flagged_delete_date date);
--rollback alter table biodata_site drop column flagged_delete_date;
